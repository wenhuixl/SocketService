...
(function($ , undefined) {
	$.fn.ace_wysiwyg = function($options , undefined) {
		...
		{
			'font' : {
				values:['Arial', 'Courier', 'Comic Sans MS', 'Helvetica', 'Open Sans', 'Tahoma', 'Verdana', '微软雅黑', '宋体'],
				icon:'fa fa-font',
				title:'字体' // Font
			},
			'fontSize' : {
			...
			'bold' : {
				icon : 'fa fa-bold',
				title : '加粗 (Ctrl/Cmd+B)' // Bold
			},
			'italic' : {
				icon : 'fa fa-italic',
				title : '斜体 (Ctrl/Cmd+I)' // Italic
			},
			'strikethrough' : {
			...
			'insertunorderedlist' : {
				icon : 'fa fa-list-ul',
				title : '项目符号' // Bullet list
			},
			'insertorderedlist' : {
				icon : 'fa fa-list-ol',
				title : '编号' // Number list
			},
			'outdent' : {
				icon : 'fa fa-outdent',
				title : '减少缩进 (Shift+Tab)' // Reduce indent
			},
			'indent' : {
				icon : 'fa fa-indent',
				title : '缩进 (Tab)' // Indent
			...
			'justifyleft' : {
				...
				title : '左对齐 (Ctrl/Cmd+L)' // Align Left
			},
			'justifycenter' : {
				icon : 'fa fa-align-center',
				title : '居中 (Ctrl/Cmd+E)' // Center
			},
			'justifyright' : {
				icon : 'fa fa-align-right',
				title : '右对齐 (Ctrl/Cmd+R)' // Align Right
			},
			'justifyfull' : {
				icon : 'fa fa-align-justify',
				title : '两端对齐 (Ctrl/Cmd+J)' // Justify
			},
			'createLink' : {
				icon : 'fa fa-link',
				title : '超链接', // Hyperlink
			...
			'unlink' : {
				...
				title : '删除超链接' // Remove Hyperlink
			},
			'insertImage' : {
				icon : 'fa fa-picture-o',
				title : '插入图片', // Insert picture
				button_text : '<i class="'+ ace.vars['icon'] + 'fa fa-file"></i> 选择图片 &hellip;',//'<i class="'+ ace.vars['icon'] + 'fa fa-file"></i> Choose Image &hellip;',
				placeholder : '图片链接', // 'Image URL'
				button_insert : '插入', // 'Insert'
			...
			'foreColor' : {
				values : color_values,
				title : '字体颜色' // Change Color
			},
			'backColor' : {
				values : color_values,
				title : '改变背景色' // Change Background Color
			},
			'undo' : {
				icon : 'fa fa-undo',
				title : '撤消 (Ctrl/Cmd+Z)' // Undo
			},
			'redo' : {
				icon : 'fa fa-repeat',
				title : '重做 (Ctrl/Cmd+Y)' // Redo
			},
			'viewSource' : {
				icon : 'fa fa-code',
				title : 'HTML代码' // View Source
			}
		}
