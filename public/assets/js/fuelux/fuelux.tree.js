			...
			this.options.dataSource( treeData ? treeData : {} , function (items) {
				...
				$.each( items.data, function(index, value) {
					...
					if(value.type === 'folder') {
						...
						$entity.find('.tree-branch-name > .icon-folder').attr("id", value.id);
						$entity.find('.tree-branch-name').attr("id", value.id+'s');
						//ACE
						...
						$entity.find('.tree-item-name > .icon-item').attr("id", value.id);
						$entity.find('.tree-item-name').attr("id", value.id+'s');
						$entity.data(value);
